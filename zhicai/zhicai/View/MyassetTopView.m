...
//- (void)initWithModel:(NSString *)dataModel
//{
//    [self creatSubViews];
//}
...
- (void)creatSubViews
{
    ...
    UIImageView *leftIMG = [CommonFunc creatImgeViewRect:CGRectMake(11,(bView.height - 21)/2, 20, 20)  Color:[UIColor greenColor] Img:nil alpha:1];
